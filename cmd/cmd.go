...
// ChemicalRun 化学式查询
func ChemicalRun() {
	filePath := "./docs/ReagentModules.xlsx"
	rowNumberAndCas := app.ParseExcel(filePath)
	var notExist int
	...
	for number, cas := range rowNumberAndCas {
		...
		// 解析HTML
		app.ParseChemical(string(body), 1, number)
	}
}
